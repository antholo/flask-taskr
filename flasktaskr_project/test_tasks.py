...
class TasksTests(unittest.TestCase):
    ...
    def test_users_name_displayed_on_task_page(self):
        self.create_user()
    ...
    def test_users_can_see_modify_links_for_tasks_they_created(self):
        self.create_user()
        self.login('Michael', 'python')
        self.app.get('tasks/tasks/', follow_redirects=True)
        self.create_task()
    ...
    def test_users_can_complete_tasks(self):
        ...
        self.assertIn('The task was marked complete. Nice.', response.data)
